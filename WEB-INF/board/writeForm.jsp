...
<input type="text" id="writename" name="writename" class="form-control" readonly value="admin">
...
<button type="submit" class="btn btn-primary">글쓰기</button> <!-- 파일업로드 시 중복되지 않는 형태로 dao구성 -->
