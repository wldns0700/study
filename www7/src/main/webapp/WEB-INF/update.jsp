...
<section>
<h3>홈쇼핑 회원 정보 수정</h3>
<form action="/memberlist/updateProc" method="post">
<table border="1">
	<tr>
		<td>회원번호(자동발생)</td>
		<td><input type="text" id="custno" name="custno" value="${member.custno}" readonly></td>
	</tr>
	
	<tr>
		<td>회원성명</td><td>
		<input type="text" id="custname" name="custname" value="${member.custname}"></td>
	</tr>
	...
	<tr>
		<td>가입일자</td>
		<td><input type="text" id="joindate" name="joindate" value="${member.joindate}"></td>
	</tr>
	
	<tr>
		<td>고급등급[A:VIP,B:일반,C:직원]</td>
		<td><input type="text" id="grade" name="grade" value="${member.grade}"></td>
	</tr>
	
	<tr>
		<td>도시코드</td>
		<td><input type="text" id="city" name="city" value="${member.city}"></td>
	</tr>
